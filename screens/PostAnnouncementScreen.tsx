...
export default function PostAnnouncementScreen({navigation, route}: any) {
  ...
  useEffect(() => {
    if (isEditing && announcementToEdit) {
      ...
      setImage(announcementToEdit.imageUrl || null);
    }
  ...
  const handlePost = async () => {
    if (!text.trim() && !image) {
      Alert.alert('Empty Announcement', 'Please write something or attach an image.');
      return;
    }
    setPosting(true);
    try {
          ...
          {!canPost ? (
            ...
            <>
              ...
              <View style={styles.sectionHeaderContainer}>
                ...
                <Text style={styles.sectionSubtitle}>Add an image or banner to accompany your announcement (optional)</Text>
              </View>
