...
import {Avatar, Header, EmptyState, Input} from '../components/ui';
...
export default function CrewScreen({navigation}: any) {
  ...
  return (
    <View style={styles.safe}>
      ...
      {loading ? <ActivityIndicator size="large" color={Colors.primary} style={{marginTop: 60}} /> : users.length === 0 ? <EmptyState icon="🎥" title="No crew found" subtitle="Try changing search terms" /> : (
